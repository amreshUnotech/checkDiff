...
export default function SignUpPasswordReset (props) {
  ...
  const checkPass = () => setError({ oldPassword: validatePassword(form.oldPassword || '') ? null : 'Password is required/invalid' })
  ...
  const isValid = !Object.values(errors).some(e => e != null) &&
    validatePassword(form.newPassword || '') && validatePassword(form.oldPassword || '') && validatePassword(form.confirmPassword || '') &&
